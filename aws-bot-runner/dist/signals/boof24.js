...
exports.BOOFINGTON24 = void 0;
exports.getBoof24Signal = getBoof24Signal;
const boof23_1 = require("./boof23");
// ─────────────────────────────────────────────
// BOOF24 SCAN LIST
// ─────────────────────────────────────────────
exports.BOOFINGTON24 = ['NVDA', 'AAPL', 'META', 'MSFT', 'AMZN', 'GOOG', 'AVGO', 'TSLA', 'LLY', 'PLTR'];
function build5mZigZag(candles1m) {
...
// ─────────────────────────────────────────────
function getBoof24Signal(candles, symbol = 'NVDA', tpPct = 0.35, slPct = 0.15) {
    const base = (0, boof23_1.getBoof23Signal)(candles, symbol, tpPct, slPct);
    if (base.signal === 'none')
        return base;
