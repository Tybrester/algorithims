...
exports.getBoof22v2Signal = getBoof22v2Signal;
const boof22_1 = require("./boof22");
// ─────────────────────────────────────────────
// CHOP MODE CONFIG
// ─────────────────────────────────────────────
const CHOP_CFG = {
...
// ─────────────────────────────────────────────
function getBoof22v2Signal(candles, symbol = 'NVDA', tpPct = 0.35, slPct = 0.15) {
    const minBars = 100;
    ...
    const result = (0, boof22_1.getBoof22Signal)(candles, symbol, tpPct, slPct);
    return {
        ...result,
