...
import { Candle, Boof23Result } from './boof23';
import { getBoof23Signal } from './boof23';
...
// ─────────────────────────────────────────────
export function getBoof23v2Signal(candles: Candle[], symbol = 'NVDA', tpPct = 0.35, slPct = 0.15): Boof23Result {
  const minBars = 100;
  ...
  const result = getBoof23Signal(candles, symbol, tpPct, slPct);
