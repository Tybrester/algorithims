"""Fetch 5 years of 1m data for all 28 BOOF55 symbols into cache55_years/"""
import alpaca_trade_api as tradeapi
import pandas as pd
import os

api = tradeapi.REST(
    'PKKPME54QJA3KBPAJ3QZZOJXDF',
    'J4GMmrbXWozxgx5FoY6kZmeNj9tCG6kmDGmyEvnXrb1Y',
...
print('\nDone. Run: python boof55_5yr_backtest.py')
