...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class Boof24Strategy : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "Boof 24 Strategy - ES IMPULSE + MNQ BREAKOUT";
                Name = "Boof24Strategy";
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (signal && direction != "")
            {
                ...
                if (direction == "long")
                {
                    ...
                    EnterLong(quantity, "Boof24_Long");
                    ExitLongStopMarket(quantity, stopPrice, "SL", "Boof24_Long");
                    ExitLongLimit(quantity, targetPrice, "TP", "Boof24_Long");
                }
                else
                {
                    double stopPrice = entryPrice + stopDistance;
                    double targetPrice = entryPrice - targetDistance;
                    EnterShort(quantity, "Boof24_Short");
                    ExitShortStopMarket(quantity, stopPrice, "SL", "Boof24_Short");
                    ExitShortLimit(quantity, targetPrice, "TP", "Boof24_Short");
                }
        ...
        [NinjaScriptProperty]
        [Display(Name = "Quantity (Contracts)", Order = 4, GroupName = "Risk")]
        public int Quantity
        {
            get { return quantity; }
