"""
BOOF 28 - Looser Confirmation MFE/MAE Study
Filters: RVOL>2.0, 5min move>0.3%, trend eff>0.5, EMA20 aligned
"""
import sys
...
def run_study():
    ...
    print('='*100)
    print('LOOSER CONFIRMATION MFE/MAE STUDY')
    print('Filters: RVOL>2.0, 5min move>0.3%, trend eff>0.5, EMA20 aligned')
